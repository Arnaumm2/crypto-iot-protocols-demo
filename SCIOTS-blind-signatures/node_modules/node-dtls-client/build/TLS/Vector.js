import { bufferToNumber, numberToBuffer } from "../lib/BitConverter.js";
    ...
    serialize(spec) {
        ...
        switch (spec.itemSpec.type) {
            ...
            case "enum":
                ...
                serializedItems = this.items.map(v => numberToBuffer(v, bitSize));
                break;
            case "struct":
        ...
        if (TypeSpecs.Vector.isVariableLength(spec)) {
            const lengthBits = (8 * fitToWholeBytes(spec.maxLength));
            ret = Buffer.concat([
