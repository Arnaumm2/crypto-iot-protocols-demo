...
import { DTLSCompressed } from "./DTLSCompressed.js";
...
export class RecordLayer {
    ...
    processOutgoingMessage(msg) {
        ...
        let packet = new DTLSPlaintext(msg.type, epoch.connectionState.protocolVersion || RecordLayer.DTLSVersion, this._writeEpochNr, ++epoch.writeSequenceNumber, // sequence number increased by 1
        msg.data);
        // compress packet
    ...
    // Default to DTLSv1.2
    static DTLSVersion = new ProtocolVersion(~1, ~2);
}
