...
export class Handshake extends TLSStruct {
    msg_type;
    ...
    static fromFragment(assembled) {
        ...
        if (HandshakeMessages[assembled.msg_type] != undefined) {
            ...
            const ret = TLSStruct.from(spec, assembled.fragment).result;
...
export class FragmentedHandshake extends TLSStruct {
    ...
    static spec = TypeSpecs.define.Struct(FragmentedHandshake);
    /**
     * The amount of data consumed by a handshake message header (without the actual fragment)
     */
    static headerLength = 1 + 3 + 2 + 3 + 3; // TODO: dynamisch?
...
export class ServerKeyExchange_PSK extends TLSStruct {
    ...
    static spec = TypeSpecs.define.Struct(ServerKeyExchange_PSK);
...
export class ClientKeyExchange_PSK extends TLSStruct {
    ...
    static spec = TypeSpecs.define.Struct(ClientKeyExchange_PSK);
