...
export class ClientHandshakeHandler {
    ...
    renegotiate() {
        ...
        hello.cipher_suites = new Vector(cipherSuites.map(cs => CipherSuites[cs].id));
    ...
    handle = {
                    ...
                    case Handshake.HandshakeType.server_hello_done:
                        ...
                        switch (connState.cipherSuite.keyExchange) {
                            case "psk":
                                ...
                                break;
                            default:
                                this.finishedCallback(new Alert(AlertLevel.fatal, AlertDescription.handshake_failure), new Error(`${connState.cipherSuite.keyExchange} key exchange not implemented`));
                                return;
                        }
        ...
        [Handshake.HandshakeType.finished]: (messages) => {
            ...
            if (finished.verify_data.equals(expectedVerifyData)) {
                ...
                this._isHandshaking = false;
                this.finishedCallback(new Alert(AlertLevel.fatal, AlertDescription.decrypt_error), new Error("DTLS handshake failed"));
